...
| 4 | LangChain 官方文档 · Retrieval / RAG | LangChain | 🛠️实践 | 另一主流框架的检索与 RAG 章节，接口视角看清各环节可插拔组件 | 向量检索, chunking, reranking | 🔗 官方免费在线：https://docs.langchain.com/oss/python/deepagents/rag |
| 5 | OpenAI Cookbook · Embeddings & RAG | OpenAI | 🛠️实践 | 官方 embedding 用法、检索问答、评估示例，API 使用者的速查手册 | 向量检索 & Embedding, 评估 | 🔗 官方免费在线：https://developers.openai.com/cookbook |
...
| 8 | 《RAG-Driven Generative AI》 | Denis Rothman（Packt） | 🛠️实践 | 系统讲用 LlamaIndex + Pinecone + Deep Lake 搭生产级 RAG 的实战书 | 全部子主题 | 🔗 正规购买（Amazon Kindle）：https://www.amazon.com/dp/B0CW18RC6F |
