...
| OWASP Top 10 for Agentic Applications 2026 为 agent 安全行业标准清单 | agent-eval-guardrails | 2026-07-09 | 沿用 security#sec-agentic 同源口径（genai.owasp.org；2026-09-05 派生条对齐） | — | A | 90 | 清单是风险目录，不是完整防护方案或合规认证 |
...
| HiAgent 2.0 主打数字员工治理；火山引擎居中国智能体开发平台私有化 17.8% / 公有云 19.3% 双第一（IDC 口径） | agent-lowcode | 2026-07-10 | volcengine.com / IDC 报道 | — | B | 90 | 份额为 IDC 口径快照，不等于产品能力或长期领先 |
...
| CU 基准两口径：Claude Opus 4.x OSWorld-Verified 83.5%（2024 年起步 14.9%）；OSWorld 2.0 长程仅 20.6%；OpenAI CUA WebVoyager 87% / OSWorld 38.1%——基准 ≠ 生产就绪 | agent-computer-use | 2026-07-11 | coasty 榜 / arXiv 2606.29537 | — | B | 90 | 受控任务集分数，不等于你的桌面流程能跑通 |
