...
| Grok 4.3：$1.25/$2.50、缓存输入 $0.20（比上代降 40–60%）；AA 智能指数 53；2026-06-15 上 Bedrock（第三家独立实验室）；SOC2/HIPAA | ml-closed | 2026-08-03 | xAI 官方 models 文档 docs.x.ai/docs/models（&lt;200k 档逐字核对；≥200k 档价格翻倍） | — | B | 30 | 媒体转述的价与指数；认证不等于你的场景合规 |
...
| 小模型：Phi-4 / Gemma 4（26B MoE 激活 ~4B；E2B 2.3B 有效参数 4GB 内存）/ SmolLM-3 为三大部署家族；sub-10B 常规超 2024 版 GPT-4 | ml-map / ml-capability | 2026-08-03 | Gemma 4 技术报告 arxiv.org/html/2607.02770v1（激活参数与内存表逐字核对） | — | B | 30 | 有效参数与内存口径来自评测，实机按量化配置复测 |
